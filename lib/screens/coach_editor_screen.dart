...
const _kTabs = [
  ...
  _TabDef(label: 'Stats',       fields: [
    (key: 'Wins',              label: 'Wins',              min: 0, max: 65535),
    (key: 'Losses',            label: 'Losses',            min: 0, max: 65535),
    (key: 'SeasonsWithTeam',   label: 'Seasons w/ Team',   min: 0, max: 65535),
    (key: 'TotalSeasons',      label: 'Total Seasons',     min: 0, max: 65535),
  ]),
];
